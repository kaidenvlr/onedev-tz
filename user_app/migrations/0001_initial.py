    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=12, validators=[user_app.validators.phone_number_validator], verbose_name='Номер телефона')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avatar/', verbose_name='Аватар пользователя')),
                ('date_of_birth', models.DateField(validators=[user_app.validators.date_of_birth_validator], verbose_name='Дата рождения')),
